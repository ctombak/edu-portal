  ...
  return (
    <div className="relative">
      <div className="pointer-events-none absolute inset-0 -z-10 overflow-hidden">
        <div className="absolute left-1/4 top-0 -translate-y-1/3 h-[500px] w-[500px] rounded-full bg-teal-600/[0.05] blur-[120px]" />
      </div>
      ...
      <div className="mx-auto max-w-3xl px-6 py-16 sm:py-24">
        ...
        <section className="mb-14">
          <div className="flex items-start gap-4">
            <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-teal-500/10 ring-1 ring-teal-500/25">
              <Lightbulb className="h-5 w-5 text-teal-400" aria-hidden />
            </div>
            <div>
