        ...
        <section className="mt-14">
          ...
          <div className="space-y-3">
            {guide.questions.map((q, i) => (
              ...
              >
                <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-violet-500/10 text-xs font-bold text-violet-400 ring-1 ring-violet-500/20">
                  {i + 1}
                </span>
